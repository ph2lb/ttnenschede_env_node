 ...
 * Lex Bolkesteijn 
 * ------------------------------------------------------------------------ 
 * Filename : TTN_Enschede_Env_Node.ino  
 * Version  : 1.0 (BETA)
 * ------------------------------------------------------------------------
...
// Keys for ttn_env_test_001
static const PROGMEM u1_t NWKSKEY[16] = { 0xEC, 0x88, 0x17, 0x61, 0xFB, 0x51, 0xB7, 0x27, 0x2D, 0xEE, 0x47, 0xCE, 0xE8, 0xC8, 0x6C, 0xCB }; // LoRaWAN NwkSKey, network session key 
static const u1_t PROGMEM APPSKEY[16] = { 0x32, 0xE9, 0x80, 0x3D, 0x5C, 0x26, 0x84, 0xF6, 0xE8, 0x44, 0x36, 0x05, 0x2E, 0x3A, 0x59, 0xFD }; // LoRaWAN AppSKey, application session key 
static const u4_t DEVADDR = 0x260117FF ;   // LoRaWAN end-device address (DevAddr)
